...
const Header = ({Language, navTrigger, setNavTrigger}) => {
  ...
  return (
    <div id="mainPageHeader" className="flexColumn unclickable" style={{zIndex: 2, position: "fixed", width: "fit-content", height: "100%", marginLeft: "15px", marginLeft: "50px", padding: "40px 0px 40px 0px", transformOrigin: "left"}}>
